	...
	function addNewElement(obj) {
		...
		var html = '<table border="0" cellpadding="0" cellspacing="5"><tr valign="top"><td width="50" align="left" valign="top">'+imgHtml+'</td><td><a target="_blank" href="http://www.facebook.com/'+obj.from.id+'/posts/'+obj.id.substring(obj.id.indexOf('_')+1)+'"><b>'+obj.from.name+'</b></a> &nbsp;:&nbsp;'+msgHtml+((obj.type=="video")?' <span style="color:#4D2600">[Video]</span>':'')+'<br>';
		if(obj.icon) {
